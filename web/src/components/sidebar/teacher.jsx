...
const EnhancedTeacherSidebar = ({ teacher }) => {
      ...
      >
        ...
        <div className="p-4 border-t border-gray-200 dark:border-gray-700">
          <div className={`flex items-center gap-3 p-3 rounded-xl bg-gradient-to-r from-emerald-50 to-purple-50 dark:from-emerald-900/20 dark:to-purple-900/20 ${sidebarCollapsed ? 'justify-center' : ''}`}>
            <motion.div 
              className="w-10 h-10 bg-gradient-to-r from-emerald-500 to-purple-600 rounded-full flex items-center justify-center text-white font-bold text-sm flex-shrink-0"
              whileHover={{ scale: 1.1 }}
            >
              {teacher.avatar}
            </motion.div>
            ...
            <AnimatePresence>
              {!sidebarCollapsed && (
                <motion.div
                  ...
                  transition={{ duration: 0.2 }}
                >
                  <p className="font-semibold text-gray-800 dark:text-gray-100 text-sm">{teacher.name}</p>
                  <p className="text-xs text-gray-500 dark:text-gray-400">{teacher.subject} Teacher</p>
                </motion.div>
              )}
            </AnimatePresence>
          ...
          >
            ...
            <div className="p-4 border-t border-gray-200 dark:border-gray-700">
              <div className="flex items-center gap-3 p-3 rounded-xl bg-gradient-to-r from-emerald-50 to-purple-50 dark:from-emerald-900/20 dark:to-purple-900/20">
                <div className="w-10 h-10 bg-gradient-to-r from-emerald-500 to-purple-600 rounded-full flex items-center justify-center text-white font-bold text-sm">
                  {teacher.avatar}
                </div>
...
export default EnhancedTeacherSidebar;