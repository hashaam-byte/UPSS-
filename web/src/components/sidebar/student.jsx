...
const EnhancedStudentSidebar = ({ student }) => {
  ...
  const sidebarItems = [
    ...
    { icon: BookOpen, label: "Study Resources", active: false },
    { icon: Bell, label: "Announcements", active: false },
    { icon: Award, label: "Guild of Scholars", active: false, premium: true },
      ...
      >
        ...
        <nav className="p-4 space-y-2 flex-1">
          {sidebarItems.map((item, index) => (
            ...
            >
              ...
              {sidebarCollapsed && (
                <div className="absolute left-full ml-2 px-2 py-1 bg-gray-800 dark:bg-gray-700 text-white text-sm rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap z-50 flex items-center gap-1">
                  {item.label}
        ...
        <div className="p-4 border-t border-gray-200 dark:border-gray-700">
          <div className={`flex items-center gap-3 p-3 rounded-xl bg-gradient-to-r from-emerald-50 to-purple-50 dark:from-emerald-900/20 dark:to-purple-900/20 ${sidebarCollapsed ? 'justify-center' : ''}`}>
            <motion.div 
              className="w-10 h-10 bg-gradient-to-r from-emerald-500 to-purple-600 rounded-full flex items-center justify-center text-white font-bold flex-shrink-0"
              whileHover={{ scale: 1.1 }}
            >
              {student.avatar}
            </motion.div>
            ...
            <AnimatePresence>
              {!sidebarCollapsed && (
                <motion.div
                  ...
                  transition={{ duration: 0.2 }}
                >
                  <p className="font-semibold text-gray-800 dark:text-gray-100 text-sm">{student.name}</p>
          ...
          >
            ...
            <div className="p-4 border-t border-gray-200 dark:border-gray-700">
              <div className="flex items-center gap-3 p-3 rounded-xl bg-gradient-to-r from-emerald-50 to-purple-50 dark:from-emerald-900/20 dark:to-purple-900/20">
                <div className="w-10 h-10 bg-gradient-to-r from-emerald-500 to-purple-600 rounded-full flex items-center justify-center text-white font-bold">
                  {student.avatar}
                </div>
...
export default EnhancedStudentSidebar;