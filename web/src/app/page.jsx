...
const UPSSHubLanding = () => {
  ...
  // Navigation functions to your existing login page
  const navigateToLogin = (role = 'student') => {
    // Store the selected role in localStorage or sessionStorage so the login page can access it
    localStorage.setItem('selectedRole', role);
    
    // Navigate to your login page - adjust the path as needed
    // For Next.js router
  ...
  const handleWebPortalClick = () => {
    navigateToLogin('student');
  };

  const handleRoleLoginClick = () => {
    navigateToLogin(activeLogin);
  };
      ...
      <section className="py-20 bg-gradient-to-r from-slate-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <motion.div 
              variants={fadeInUp} 
              className="text-center p-8 bg-white rounded-2xl shadow-lg cursor-pointer hover:shadow-xl transition-all duration-300"
