// /app/protected/headadmin/schools/create/page.jsx
'use client'
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-1">Add a new school to the platform with admin access</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="space-y-4">
              <label className="flex items-center">
                <input
                  ...
                  disabled={isLoading}
                />
                <span className="ml-3 text-sm text-gray-700">Allow student self-registration</span>
              </label>
              ...
              <label className="flex items-center">
                <input
                  ...
                  disabled={isLoading}
                />
                <span className="ml-3 text-sm text-gray-700">Require email verification for new users</span>
              </label>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-xl font-semibold text-gray-900">School Admin Information</h2>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleInputChange}
                  className="w-full px-4 py-3 pr-12 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500"
        ...
        <div className="flex flex-col sm:flex-row items-center justify-end gap-4">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full sm:w-auto px-8 py-3 bg-yellow-600 text-white rounded-lg hover:bg-yellow-700 transition-colors flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isLoading ? (
              <>
