// /app/protected/teacher/class/layout.jsx
'use client';
...
const ClassTeacherLayout = ({ children }) => {
  ...
  const verifyClassTeacherAccess = async () => {
    try {
      ...
      // Verify user is a class teacher
      if (data.user.role !== 'teacher' || data.user.department !== 'class_teacher') {
  ...
  const fetchNotifications = async () => {
    try {
      const response = await fetch('/api/protected/teacher/class/notifications?limit=5&read=false');
  ...
  const sidebarItems = [
    ...
    {
      name: 'Assignments',
      href: '/protected/teacher/class/assignments',
      icon: BookOpen
    },
    {
      name: 'Analytics',
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="relative">
                <button
                  onClick={() => router.push('/protected/teacher/class/notifications')}
